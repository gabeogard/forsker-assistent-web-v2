...
export default function Document() {
  return (
    ...
    <meta name='description' content="Transkribering"/>
    <meta name="description" content="Forskningshjelp"/>
    <meta name="description" content="Transkribering av intervju"></meta>
      <Head />
      <body>
        <Main />
        <NextScript />
