    ...
    <div className="hero min-h-screen bg-base-200">
      <div className="hero-content text-center">
        <div className="max-w-md">
          <h1 className="lg:text-5xl md:text-4xl sm:text-3xl font-bold">Om oss</h1>
          <p className="py-6 lg:text-xl text-l">
          ...
          <h2 className="md:text-4xl sm:text-3xl lg:text-4xl font-bold">Anita Øgård-Repål</h2>
          <p className="lg:py-6 md:py-4 sm:py-4 text-l">Universitetslektor/Ph.D stipendiat, Universitetet i Agder</p>
          <h2 className="md:text-4xl sm:text-3xl lg:text-4xl font-bold">Monika Øgård</h2>
          <p className="lg:py-6 md:py-4 sm:py-4  text-l">Universitetslektor/Ph.D stipendiat, Universitetet i Agder</p>
        </div>
      </div>
    </div>
